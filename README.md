...
[![Build Status](https://travis-ci.org/NovikovRoman/utls.svg?branch=master)](https://travis-ci.org/NovikovRoman/utls)
[![godoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://godoc.org/github.com/NovikovRoman/utls#UConn)
---
...
so you are encouraged to use [godoc](https://godoc.org/github.com/NovikovRoman/utls#UConn).
...
# Client Hello IDs
See full list of `clientHelloID` values [here](https://godoc.org/github.com/NovikovRoman/utls#ClientHelloID).  
...
1. Import this library (e.g. `import tls "github.com/NovikovRoman/utls"`)
